...
################
 ...
 ####
 echo "awk '{print \$1,\$2}' \$FILE1 > tmp1" >>paste_$BBRR.sh  
 echo "awk '{print \$2}' \$FILE2 > tmp2" >>paste_$BBRR.sh  
 echo "awk '{print \$2}' \$FILE3 > tmp3" >>paste_$BBRR.sh  
 echo "awk '{print \$2}' \$FILE4 > tmp4" >>paste_$BBRR.sh  
 echo "paste tmp1 tmp2 tmp3 tmp4 > \$OUTPUT" >>paste_$BBRR.sh   
 ####
