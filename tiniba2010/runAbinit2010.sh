...
#echo "ndivk2   100 120  # 10, 12 and 17 divisions of the 3 segments," >> $CASO.in  
echo "ndivk2   100 120 1700   # 10, 12 and 17 divisions of the 3 segments," >> $CASO.in  
...
#echo "kptbounds2  0.66667   0.0   0.0  # K point" >> $CASO.in  
#echo "            0.0       0.0       0.0 # Gamma point" >> $CASO.in  
#echo "            0.5       0.28868   0.0 # M point" >> $CASO.in  
#echo "            1.0  1.0  1.0 # Gamma point in another cell." >> $CASO.in  
