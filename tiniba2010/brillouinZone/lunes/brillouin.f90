...
!!! ========= write energy ===================
! do ik = 1, kMax
!  WRITE(34,FMT=117) ik, energy(ik,1:nMax)
! end do 
!117    FORMAT(I6,80F21.16)
!!! ========= scissors energy ================
!!! ========= scissors energy ================
!!! ========= scissors energy ================
    write(*,*)actualBandGap
...
!!! write the integrand ============
 do ik = 1, kMax
      do  iv = 1, nVal
        do ic = iv, nMax
          write(39,"(3I,1E15.7)")ik,iv,ic,real(momMatElem(1,ic,iv)*momMatElem(1,iv,ic)) 
