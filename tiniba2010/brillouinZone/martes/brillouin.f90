...
!!! write the integrand ============
 !!!================================
   do ik = 1, kMax
      do  iv = 1, nVal
        do ic = nVal+1,nMax !nVal+1, nMax
          write(49,"(3I,1E15.7)")ik,iv,ic,real(posMatElem(1,ic,iv)*posMatElem(1,iv,ic)) 
          !write(39,*)ik,iv,ic,real(momMatElem(1,ic,iv)*momMatElem(1,iv,ic))          
        end do
      end do 
   end do  
!!!================================
                ...
                DO ix=1,3
                 DO iy=1,3
                  ctmp = ctmp + T2(ix,iy)*posMatElem(ix,ic,iv)*posMatElem(iy,iv,ic)
                      write(50,"(3I,2E15.7)")punto,iv,ic,real(momMatElem(1,ic,iv)*momMatElem(1,iv,ic)), aimag(momMatElem(1,ic,iv)*momMatElem(1,iv,ic))
                 END DO
                END DO
                write(79,"(3I,1E15.7)")ik,iv,ic,real(momMatElem(1,ic,iv)*momMatElem(1,iv,ic)) 
               IF (ic==nMax) THEN
