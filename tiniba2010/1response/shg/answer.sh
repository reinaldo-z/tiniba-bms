...
NO="no-used"
NAMERES[1]="chi1"; 
NAMERES[2]=""      ;SIZERES[2]="3"
NAMERES[3]="$NO"   ;SIZERES[3]="3"
NAMERES[4]="$NO"   ;SIZERES[4]="3"
NAMERES[5]="$NO"   ;SIZERES[5]="3"
NAMERES[6]="$NO"   ;SIZERES[6]="3"
NAMERES[7]="$NO"   ;SIZERES[7]="3"
NAMERES[8]="$NO"   ;SIZERES[8]="3"
NAMERES[9]="$NO"   ;SIZERES[9]="3"
