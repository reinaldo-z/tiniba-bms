...
!        counter=counter+1
!      write(34,'(a9,1I6,a5,1I8,a2,1f8.3,a9,1I6,a2,1f8.3,a12)')"set arrow",counter,"from",ik,",",(energy(ik,nValwish)),"-Evv to",ik,",",(energy(ik,nVal+CCC)),"-Evv nohead"
