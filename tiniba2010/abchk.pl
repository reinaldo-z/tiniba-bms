...
# jzwanzig@dal.ca ; modificated by Cabellos 25 July 2007 at 11:29 
...
@abinit_variables = ("acell","angdeg","amu","algalch","chkprim","nsppol",
  ...
  system("rm -f killme"); ### erase killme if exist ...

#now set number of unknown variables to 0.
$INPUTFILE=$ARGV[0]; ##any way im going to take the input here 
$unknown_variables = 0;
