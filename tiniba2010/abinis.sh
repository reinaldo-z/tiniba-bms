...
FILE="perro.sh"
echo "#!/bin/bash " > $FILE
echo "## please keep this history." >> $FILE
echo "## LAST MODIFICATION :  Febrero 18 2010 by Cabellos  a 16:52" >> $FILE
echo "## LAST MODIFICATION :  Febrero 18 2010 by Cabellos  a 18:06" >> $FILE
echo "## AUTHOR            :  J.L. Cabellos " >> $FILE
echo "## REPORTING BUGS    :  Report bugs to <sollebac@gmail.com>." >> $FILE

echo "     RED='\e[0;31m'" >> $FILE
echo "     BLUE='\e[0;34m'" >> $FILE
echo "      BLU='\e[1;34m'" >> $FILE
echo "     CYAN='\e[0;36m'" >> $FILE
echo "    GREEN='\e[0;32m'" >> $FILE
echo "      GRE='\e[1;32m'" >> $FILE
echo "   YELLOW='\e[1;33m'" >> $FILE
echo "       NC='\e[0m' # No Color" >> $FILE



echo "    WORKZPACE=\"workspace\"         ">> $FILE
echo "      BASEDIR=\`dirname \$PWD\`     ">> $FILE
echo "       PARENT=\`basename \$BASEDIR\`">> $FILE
echo "         CASO=\`basename \$PWD\`    ">> $FILE
     


echo " declare -a FALSEMACHINESpmn">> $FILE
echo " declare -a VIVOS           ">> $FILE
echo " declare -a MUERTOS         ">> $FILE
echo "### hha this all the cluster jl">> $FILE
echo "MAQ501[1]=\"node01\";MAQ501[12]=\"node12\";MAQ501[23]=\"quad04\" ">> $FILE
echo "MAQ501[2]=\"node02\";MAQ501[13]=\"node13\";MAQ501[24]=\"quad05\" ">> $FILE
echo "MAQ501[3]=\"node03\";MAQ501[14]=\"node14\";MAQ501[25]=\"quad06\" ">> $FILE
echo "MAQ501[4]=\"node04\";MAQ501[15]=\"node15\";MAQ501[26]=\"quad07\" ">> $FILE
echo "MAQ501[5]=\"node05\";MAQ501[16]=\"itanium01\";MAQ501[27]=\"quad08\"">> $FILE
