...
!!!
  ...
  IF ( opmn ) THEN
     ...
     OPEN(UNIT=u_vme,FILE="pnn.d", FORM="unformatted") ! <n|p|n> velocity matrix elements
  END IF
...
!!! reads the G vectors
        ...
        IF ( oem ) THEN
!           WRITE(10,"(1i4,1000f18.12)")ik,eigen(1:nbandk)*HaeV
           WRITE(10,"(1i7,1000f22.16)")ik,eigen(1:nbandk)*HaeV
